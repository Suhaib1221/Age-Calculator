...
// let favPhone = prompt("Enter Your fav phone name")

// document.write("My Favorite Phone is : " , favPhone , "<br>" , "Length is : " , favPhone.length);


// Question 03: Write a program to find the index of letter “n” in the word “Pakistani” and display the result in your browser. ?

// let find = prompt("Enter leter to find index of Pakistan").toLowerCase()
// let name1 =  "pakistan"
...
// Question 04: Write a program to find the last index of letter “l” in theword “Hello World” and display the result in your browser.?


// let word = "Hello World";

// console.log(word , "Last index of 'l'", word.lastIndexOf("l"));





// Question 05: Write a program to find the character at 3rd index in theword “Pakistani” and display the result in your browser.?

// let contry = "Pakistani";
// let index = +prompt("enter your index")

// console.log(contry , "Character st index 3 : " , contry[index]);


// Question 06: Write a program to replace the “Hyder” to “Islam” in theword “Hyderabad” and display the result in your browser. ?


// var city = "Hyderabad"; // The original word
// var newCity = city.replace("Hyder", "Islam"); // Replace "Hyder" with "Islam"

// console.log("Original city: " + city);
// console.log("Modified city: " + newCity);
// document.write("The modified city name is: " + newCity);


// Question 07: Write a program to replace all occurrences of “and” in the string with “&” and display the result in your browser.?


// var message = "Ali and Sami are best friends. They play cricket and football together" // The original word
// var newWord = message.replace("and", "&"); // Replace "and" with "&"

// console.log("Original word: " + message);
// console.log("Modified word: " + newWord);
// document.write("The modified word name is: " + newWord);



// Question 08 :  Write a program that converts a string “472” to a number 472 Display the values & types in your browser.?
...
// Question 09 : Write a program that takes user input. Convert and show the input in capital letters.?

// let user = prompt("Enter").toUpperCase();
// console.log(user);

// Question 12 : Write a program that takes user input. Convert and show the input in small letters.?

// let user = prompt("Enter").toLowerCase();
// console.log(user);
...
//  if (str.slice(i, i + 2) === " ") {
//     alert("Double spaces found at index " + i);
...
// var find = +prompt("Find prime number");
// var isprime = false
// if (find < 2) {
//     console.log("It's not prime number");
    
// }else{
//     for (var i = 2; i <= Math.sqrt(find); i++) {
//         if ( find % i === 0 ){
//             console.log(find,"Is not prime");
//             isprime = true;
//             break;
//         }
//     }
...
if (!isNot){
    console.log("this not palendrum");
...
//     var input = prompt("Enter your pelendum word like").toLowerCase();
//     var palendrum = [];
//     var ifTrue=false;
...
// if (palendrum === input) {
//     console.log("this is palendrum");
//     ifTrue = true
// }
// if (!ifTrue){
//     console.log("This is no palendrum");
    
// }


// var series = [11,12,14,18,19,22];
// var missing = [];
...
//             // missing += series[i] + j + ","           
//             // missing.push(series[i] + j)
//             // console.log(series[i] + j);
//             series.splice (i+j , 0 , series[i]+j )
...
// for (var i = 0; i < numChars - 1; i++) { // loop until the second last character
//     if (str[i] === " " && str[i + 1] === " ") { // check for two consecutive spaces
//         alert("Double spaces found at index " + i);
//         break;
//     }
// }
